...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes: Array<{
    ...
    { path: "/services/parenting-coaching", priority: 0.9, changeFrequency: "weekly" },
    { path: "/services/relationship-repair", priority: 0.9, changeFrequency: "weekly" },
    { path: "/services/counselling-life-coaching", priority: 0.9, changeFrequency: "weekly" },
